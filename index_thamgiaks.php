...
if (isset($_POST['send'])) {
    $id_nguoiks  = $_SESSION['khaosat']['id'];
    $q1     = trim($_POST['q1']);
    $q2  = trim($_POST['q2']);
    $q3   = trim($_POST['q3']);
    $q4     = trim($_POST['q4']);
    ...
    $q6      = trim($_POST['q6']);
    $q =$q1."-".$q2."-".$q3."-".$q4."-".$q5."-".$q6;
    $sql = "INSERT INTO `kq_khaosat`(`kq_cauhoi`, `id_nguoikhaosat`) VALUES ('{$q}', '{$id_nguoiks}')";
    $insert = mysqli_query($connect, $sql);
    if ($insert) {
       echo "Cảm ơn bạn đã hoàn thành khảo sát này !!!";
        exit;
    } else {
...
<Body>
  <div class="panel" style="box-shadow: none;">
        <h2 style="font-family:time new roman;font-size:38px;font-weight: 1000;text-align: center;margin-top: 70px"> Điền vào phiếu khảo sát</h2>
